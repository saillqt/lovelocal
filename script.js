...
const STATIONS = [
  ...
  },
  {
    ...
    kind: "product",
    label: "Flyer",
    thumb: "assets/side_1.png",
    peek: { left: ["assets/mockup_1.png"], right: ["assets/mockup_2.png"] }, // peek out at the sides when you arrive
    panel: {
      ...
      faces: ["assets/side_1.png", "assets/side_2.png"], // flip front/back
    },
  },
  {
    id: "bag", map: "Bag",
    kind: "product",
    label: "Delivery Bag",
    thumb: "assets/bag_front.png",
    peek: { left: ["assets/bag_mockup_1.png", "assets/bag_mockup_3.png"], right: ["assets/bag_mockup_2.png", "assets/bag_mockup_4.png"] },
    panel: {
      ...
      faces: ["assets/bag_front.png", "assets/bag_back.png"],
    },
  },
  {
    id: "insta", map: "Post",
    ...
    thumb: "assets/Instagram_post.png",
    panel: {
      ...
      phone: "assets/Instagram_post.png", // shown inside phone.png frame
  ...
  },
  {
    ...
    kind: "product",
    label: "Litchi Story",
    thumb: "assets/litchi-poster.png",
    panel: {
      ...
      phoneVideo: "assets/litchi-story.mp4",
    },
  },
  {
  ...
  if (data.isInstagram) {
    ...
    return `<div class="ig">
      <header class="ig__head">
        <span class="ig__avatar"><img src="assets/lovelocal-logo.svg" alt="" /></span>
        <span class="ig__meta">
